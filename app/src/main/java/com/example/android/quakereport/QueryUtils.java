    ...
    public static ArrayList<EarthquakeData> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            for(int i=0; i<earthquakeArray.length(); i++)
            {
                ...
                magnitude = currentEarthquake.getDouble("mag");
                location = currentEarthquake.getString("place");
                timestamp = currentEarthquake.getLong("time");
                url = currentEarthquake.getString("url");
                earthquakes.add(new EarthquakeData(magnitude, location, timestamp, Uri.parse(url)));
            }
